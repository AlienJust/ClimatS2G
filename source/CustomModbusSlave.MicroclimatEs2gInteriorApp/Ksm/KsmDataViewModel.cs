	...
	class KsmDataViewModel : ViewModelBase, IParameterSetter, IAllParametersAccepter {
		...
		public KsmDataViewModel(IThreadNotifier notifier) {
			...
			_parameterVmList = new List<IKsmParameterViewModel> {
				...
				, new KsmCommonWritableParameterViewModel(1, "Датчик 1wire №2 " /*, new UshortToDoubleConverterNcalc("UshRv * 0.01")*/, new TextFormatterNcalcDouble("UshRv * 0.01", "f2", "хз")), new KsmCommonWritableParameterViewModel(2, "Резерв" /*, new UshortToDoubleConverterNcalc("UshRv * 1.0")*/, new TextFormatterNcalcDouble("UshRv * 1.0", "f0", "хз")), new KsmCommonWritableParameterViewModel(3, "Резерв" /*, new UshortToDoubleConverterNcalc("UshRv * 1.0")*/, new TextFormatterNcalcDouble("UshRv * 1.0", "f0", "хз")), new KsmBitsParameterViewModel(4, "PIC порт B" /*, new UshortToDoubleConverterNcalc("UshRv * 1.0")*/, new TextFormatterBits("хxxxxxxx")
				...
				, new KsmBitsParameterViewModel(7, "Диагностика контроллера (ErrorsFlags)", new TextFormatterBits("хxxxxxxx хxxxxxxx")
					, null)
