...
namespace CustomModbusSlave.MicroclimatEs2gApp.SetParams.AnyParameter {
	class SettableAnyParameterViewModel : ViewModelBase {
		...
		public SettableAnyParameterViewModel(int paramIndex, string name, double maxValue, double minValue, double? doubleValue, string stringFormat, IDoubleUshortConverter doubleUshortConverter, IParameterSetter parameterSetter, IThreadNotifier uiNotifier) {
