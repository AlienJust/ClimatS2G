...
namespace CustomModbusSlave.Es2gClimatic.InteriorApp.SystemDiagnostic
{
    class SystemDiagSalonViewModel : ViewModelBase
    {
        ...
        private string _cleanerWorkHourCounter1;
        private string _cleanerWorkHourCounter2;
        private string _cleanerWorkHourCounter3;
        private string _cleanerWorkHourCounter4;
        ...
        private void CmdListenerKsmOnDataReceived(IList<byte> bytes, IList<BytesPair> data)
        {
            _uiNotifier.Notify(() =>
            {
                ...
                CleanerWorkHourCounter1 = data[39].HighFirstUnsignedValue.ToString();
                CleanerWorkHourCounter2 = data[50].HighFirstUnsignedValue.ToString();
                CleanerWorkHourCounter3 = data[51].HighFirstUnsignedValue.ToString();
                CleanerWorkHourCounter4 = data[52].HighFirstUnsignedValue.ToString();
        ...
        void ResetVmPropsToDefaultValues()
        {
            ...
            CleanerWorkHourCounter1 = UnknownText;
            CleanerWorkHourCounter2 = UnknownText;
            CleanerWorkHourCounter3 = UnknownText;
            CleanerWorkHourCounter4 = UnknownText;
        ...
        public string CleanerWorkHourCounter1
        {
            get => _cleanerWorkHourCounter1;
            set
            {
                if (_cleanerWorkHourCounter1 != value)
                {
                    _cleanerWorkHourCounter1 = value;
                    RaisePropertyChanged(() => CleanerWorkHourCounter1);
                }
            }
        }
        public string CleanerWorkHourCounter2
        {
            get => _cleanerWorkHourCounter2;
            set
            {
                if (_cleanerWorkHourCounter2 != value)
                {
                    _cleanerWorkHourCounter2 = value;
                    RaisePropertyChanged(() => CleanerWorkHourCounter2);
                }
            }
        }
        public string CleanerWorkHourCounter3
        {
            get => _cleanerWorkHourCounter3;
            set
            {
                if (_cleanerWorkHourCounter3 != value)
                {
                    _cleanerWorkHourCounter3 = value;
                    RaisePropertyChanged(() => CleanerWorkHourCounter3);
                }
            }
        }
        public string CleanerWorkHourCounter4
        {
            get => _cleanerWorkHourCounter4;
            set
            {
                if (_cleanerWorkHourCounter4 != value)
                {
                    _cleanerWorkHourCounter4 = value;
                    RaisePropertyChanged(() => CleanerWorkHourCounter4);
                }
            }
        }
